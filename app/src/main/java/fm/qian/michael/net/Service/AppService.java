...
import static fm.qian.michael.net.http.HttpModule.ID;
import static fm.qian.michael.net.http.HttpModule.OS;
import static fm.qian.michael.net.http.HttpModule.Q;
import static fm.qian.michael.net.http.HttpModule.P;
