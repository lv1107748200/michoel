...
import com.xxbm.musiclibrary.filecache.FileCacheManger;
...
import com.xxbm.musiclibrary.receiver.MediaButtonIntentReceiver;
...
import static com.xxbm.sbecomlibrary.com.GlobalVariable.BaseUrlONE;
    ...
    private void handleCommandIntent(Intent intent) {
        ...
        if (CMDNEXT.equals(command) || NEXT_ACTION.equals(action)) {
            ...
            if(!mIsLocked && isPlaying()){
                mIsLocked = true;
                Intent lockscreen = new Intent("fm.qian.michael.ui.activity.LockActivity");
    ...
    public void updateNotification(final String what) {
        ...
        if(!CheckUtil.isEmpty(comAll.getCover_small())){
            ...
            if(NetStateUtils.isNetworkConnected(this)){
                ...
                String pathImage = DownPathUtil.createImagePath(imagePath);
